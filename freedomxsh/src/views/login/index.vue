          ...
          >
            ...
            <div class="captcha">
              ...
              <div class="captcha-content">
                <i v-if="captchaLoading" class="el-icon-loading" />
                <div
                  v-else
                  class="svg-captcha"
                  @click="getCaptcha"
  ...
  watch: {
    $route: {
      handler: function (route) {
        console.log(route, "获取路由监听改变信息666666666");
      ...
      this.$refs.loginForm.validate(async (valid) => {
        if (valid) {
          ...
          try {
            ...
            console.log(this.redirect, "获取登入之后跳转哪个路由5555555");
            console.log(this.otherQuery, "路由传参数77777777");
            this.$router.push({
              path: this.redirect || "/",
