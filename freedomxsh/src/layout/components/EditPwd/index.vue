<template>
  ...
  >
    <el-form ref="form" :model="model" status-icon :rules="rules" label-width="100px" :label-position="mobile ? 'top' : 'right'">
      <el-form-item label="原密码" prop="oldPassword">
        <el-input v-model="model.oldPassword" type="password" placeholder="请输入原密码" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="新密码" prop="newPassword">
        <el-input v-model="model.newPassword" type="password" placeholder="新密码：8-16位数字、字母或符号的两者结合" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="确认新密码" prop="confirmPassword">
        <el-input v-model="model.confirmPassword" type="password" placeholder="请再次输入新密码" autocomplete="off"></el-input>
      </el-form-item>
      ...
      <el-form-item>
        ...
        <el-button :disabled="isDisabled" @click="handleDialogClose">取消</el-button>
      </el-form-item>
    </el-form>
  </el-dialog>
</template>
